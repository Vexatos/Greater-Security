...
public class FileManager 
{
	...
	public static void updateFiles() throws IOException
	{
		if(folder.exists())
		{
			...
			for(ActionInstance blocks : breakEventList)
			{
				...
				String str = blocks.time+" "+blocks.loc.xx+"x "+blocks.loc.yy+"y "+blocks.loc.zz+"z "+blocks.player.username+" "+blocks.act.name+" "+blocks.block.getBlockName();
	...
	public static void addEvent(Loc loc,action act, EntityPlayer player, Block block)
	{
