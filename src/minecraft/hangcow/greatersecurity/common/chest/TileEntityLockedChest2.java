...
public class TileEntityLockedChest2 extends TileEntity implements IInventory
{
	...
	public TileEntityLockedChest2 adjacentChestZNeg;

	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityLockedChest2 adjacentChestXPos;

	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityLockedChest2 adjacentChestXNeg;

	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityLockedChest2 adjacentChestZPosition;
	...
	private void func_90009_a(TileEntityLockedChest2 par1TileEntityChest, int par2)
	{
	...
	public void checkForAdjacentChests()
	{
		if (!this.adjacentChestChecked)
		{
			...
			{
				this.adjacentChestXNeg = (TileEntityLockedChest2) this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
			}

			if (this.worldObj.getBlockId(this.xCoord + 1, this.yCoord, this.zCoord) == Block.chest.blockID)
			{
				this.adjacentChestXPos = (TileEntityLockedChest2) this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
			}

			if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord - 1) == Block.chest.blockID)
			{
				this.adjacentChestZNeg = (TileEntityLockedChest2) this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
			}

			if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord + 1) == Block.chest.blockID)
			{
				this.adjacentChestZPosition = (TileEntityLockedChest2) this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
			}
