...
public enum HardnessTiers
{
	...
	WOOD("Wood", 100, 100,false, Block.planks, 4), STONE("Stone", 0, 0,false, Block.stoneBrick, 4), COPPER("Copper", 0, 0,true, "CopperPlates",4), BRONZE("Bronze", 0, 0,true, "BronzePlates", 4), IRON("Iron", 0, 0,true), STEEL("Steel", 0, 0,true), DIAMOND("Crystal", 0, 0,false), VOID("Void", 0, 0,false);
