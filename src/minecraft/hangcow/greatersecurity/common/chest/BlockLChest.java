...
public class BlockLChest extends BlockContainer
{
    private Random random = new Random();
    private Random furnaceRand = new Random();

    public BlockLChest(int par1)
    {
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityLChest var6 = (TileEntityLChest) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object var10 = (TileEntityLChest) world.getBlockTileEntity(i, j, k);
        ...
        for (int s = 0; s < 4; s++)
        {
            ...
            int bType = getType(world, i + deltaX, j, k + deltaZ);
            int tType = getType(world, i, j, k);
            if (world.getBlockId(i + deltaX, j, k + deltaZ) == this.blockID && tType == bType && (world.isBlockSolidOnSide(i + deltaX, j, k + deltaZ, DOWN))) { return true; }
        }
        ...
        else
        {
            ...
            if (blockEntity instanceof TileEntityLChest)
            {
                TileEntityLChest Chest = (TileEntityLChest) blockEntity;
    ...
    public void breakBlock(World world, int i, int j, int k, int par5, int par6)
    {
        ...
        TileEntityLChest var7 = (TileEntityLChest) world.getBlockTileEntity(i, j, k);
        int meta = world.getBlockMetadata(i, j, k);
