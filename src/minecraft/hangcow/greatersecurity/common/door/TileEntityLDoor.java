...
public class TileEntityLDoor extends TileEntity implements IPacketReceiver {
    ...
    public boolean canAccess(TileEntityLDoor tileEntityLDoor,EntityPlayer player)
    {	
    	if(tileEntityLDoor instanceof TileEntityLDoor)
         {	
        ...
        public void updateEntity()
        {
            ...
            if (++this.tickSnyc % 20 * 4 == 0)
    		{
	    				...
	    				if(timeOpen >= this.closeTime )
	    				{
	    					...
	    					if(bMeta > 3 && bMeta < 8)
	    					{
	    						BlockLDoor.activateDoor(worldObj,xCoord,yCoord,zCoord);
    	    	...
    	    	if(!worldObj.isRemote)
    	    	{
    				...
    				PacketManager.sendDoorPacketPacket(this, 0, this.owner,users);
