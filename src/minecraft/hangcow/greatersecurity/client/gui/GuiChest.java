...
public class GuiChest extends GuiContainer
{
	...
	public GuiChest(IInventory upperChestInv, IInventory lowwerChestInv)
	{
		super(new ContainerChest(upperChestInv, lowwerChestInv));
		this.upperChestInventory = upperChestInv;
		this.lowerChestInventory = lowwerChestInv;
		this.allowUserInput = false;
		short var3 = 222;
		int var4 = var3 - 108;
		this.inventoryRows = lowwerChestInv.getSizeInventory() / 9;
