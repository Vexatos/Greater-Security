...
public class GuiDestroyResponce extends GuiContainer
{
	...
	public void initGui()
	{
		...
		int bHig = 10;
		int tWid = 85;
		this.buttonList.add(new GuiButton(0, wid + tWid + 20, hig, 40, 12, var1.translateKey("Yes")));
	...
	protected void actionPerformed(GuiButton par1GuiButton)
	{
		if (par1GuiButton.id == 0)// boom
		{
			...
			tileEntity.worldObj.setBlockAndMetadataWithNotify(tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord, 0, 0, 3);
